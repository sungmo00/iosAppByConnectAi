...
## 요약
YouTube API 키 유효성 확인 및 trend_sniper.py 실행 오류 진단. Developer가 API 설정 검증 후 수정.

## 분배
- **💻 코다리**: youtube_account.json의 YouTube API 키 유효성 검사 후 trend_sniper.py 단독 실행하여 설정 오류 파악 및 수정
